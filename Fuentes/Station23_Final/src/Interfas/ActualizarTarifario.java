...
public class ActualizarTarifario extends javax.swing.JFrame {
    ...
    private DefaultTableModel imprimirDatos() {
        ...
        for (Tarifario tarifario : tarifas) {
            ...
            String comision = String.format("%.2f", tarifario.getTarifa_hora());
            modelo.addRow(new Object[]{contador, tarifario.getTipo_vehiculo(), tarifa, comision});
            contador++;
        }
        return modelo;
    }
...
@SuppressWarnings("unchecked")
    ...
    private void jbtActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtActualizarActionPerformed
        int vehiculo = daoTipoVehiculo.obtenerID(jtfTarifa.getText());
        Double tarifaNueva = Double.valueOf(jtfTarifa.getText());
        Double comisionNueva = Double.valueOf(jtfComision.getText());
