...
public class PagoYape extends javax.swing.JFrame {
    ...
    public PagoYape(Registro r, Pago p, double HORAS_TOTALES_REDONDEADO, double c, double costo_total) {
        initComponents();
        comision=c;
    ...
    private void pagar(){
        ...
        pago.setModalidad("Billetera - Yape");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img_yape.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jpnlFondoImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 683, Short.MAX_VALUE)
        );
